...
begin
  ...
  $DB.run "ALTER TABLE annotationdata ADD FOREIGN KEY (owner) REFERENCES users(login)"
...
#DANGEROUS NUKE COMMAND WHICH NUKES ALL OF THE TABLES.
get '/nuke' do
begin
  handleuser
  db_connect
